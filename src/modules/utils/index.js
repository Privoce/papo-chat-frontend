...
export function setToken(value) {
  return setCookie(
    process.env.TOKEN_COOKIE_KEY,
    value,
    process.env.TOKEN_COOKIE_EXPIRES
  );
}

export function setUser(value) {
  return setCookie(
    process.env.USER_COOKIE_KEY,
    value,
    process.env.USER_COOKIE_EXPIRES
  );
}

export function getToken() {
  return getCookieJson(process.env.TOKEN_COOKIE_KEY);
}

export function getUser() {
  return getCookieJson(process.env.USER_COOKIE_KEY);
}

export function removeToken() {
  return removeCookie(process.env.TOKEN_COOKIE_KEY);
}

export function removeUser() {
  return removeCookie(process.env.USER_COOKIE_KEY);
}
